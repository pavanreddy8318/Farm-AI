...
export default function AgronomistChat() {
  ...
  const handleClearChat = async () => {
    try {
      ...
      console.warn('Failed to clear server chat log:', err);
    }
  ...
  return (
    <div id="agronomist-chat-module" className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start h-full">
      ...
      <div id="chat-guidelines-col" className="lg:col-span-4 space-y-6">
        <div id="agronomist-intro-card" className="bg-editorial-sand border border-editorial-border rounded-none p-6 space-y-4">
        ...
        <div id="quick-prompts-card" className="bg-editorial-sand border border-editorial-border rounded-none p-6 space-y-3.5">
      ...
      <div id="chat-stream-col" className="lg:col-span-8 h-full flex flex-col">
        <div id="chat-container-card" className="bg-editorial-cream border border-editorial-border rounded-none shadow-xs flex flex-col h-[520px] overflow-hidden">
          ...
          <div id="chat-history-scroller" className="flex-1 overflow-y-auto p-6 space-y-5 bg-editorial-cream/20">
            {messages.map((msg) => {
                ...
                >
                  ...
                  <div className="space-y-1">
                    <div className={`p-4 rounded-none ${
                      isAssistant 
                        ? 'bg-editorial-sand border border-editorial-border text-editorial-dark shadow-xs' 
            ...
            {isLoading && (
              <div id="chat-loading-item" className="flex gap-3 max-w-[80%] mr-auto items-start">
                ...
                <div className="p-4 bg-editorial-sand border border-editorial-border rounded-none shadow-xs flex items-center gap-2">
          ...
          {/* Text Input Footer */}
          <div id="chat-input-footer" className="p-4 bg-editorial-sand border-t border-editorial-border flex-shrink-0">
            <form 
              onSubmit={(e) => {
                e.preventDefault();
            ...
            >
              ...
              />
              <VoiceDictator 
                onTranscript={(transcript) => setInputText((prev) => prev ? `${prev} ${transcript}` : transcript)}
                size="md"
              />
              <button
                type="submit"
